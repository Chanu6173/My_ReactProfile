          ...
          <div className="content flexSB">
            <div className="left w-half">
              <div className="hero-content-box">
                <span className="hero-sub-title">I am Chanu</span>
                ...
                <div className="hero-image-box d-md-none text-center">
                  <img src="assets/img/hero/me2.png" alt="" />
                </div>

                <p className="lead">I simplify complex UX, backend, and AI challenges to create powerful 🚀 , high-performance solutions that deliver seamless digital experiences.</p>
            ...
            <div className="right w-half">
              <div className="hero-image-box text-center ">
                <img src="../images/common/me2.png" alt="logo" />
              </div>
            </div>
          </div>
